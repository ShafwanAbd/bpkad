    ...
    <div class="permohonan_main main_side_menu">
        <div class="container shadow">
            <div class="flex flex-column">
                <div class="d-flex justify-content-between align-items-center mb-3 permohonan-header">
                    <div class="d-flex align-items-center gap-3">
                        <h4 class="mb-0">Permohonan</h4>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        @if(Auth::User()->role != 'Admin' && Auth::User()->role != 'Superadmin')
                            <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#tambahpermohonan">Tambah</a>
                        @endif
                    </div>
                </div>
            ...
            <div class="data_container mt-2">
                <table id="permohonanTable" class="display nowrap cell-border hover" cellspacing="0" style="width:100%">
