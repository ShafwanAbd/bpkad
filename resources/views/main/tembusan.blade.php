...
<div class="permohonan_container flex">
    ...
    <div class="permohonan_main main_side_menu">
        <div class="container shadow">
            <div class="d-flex justify-content-between align-items-center mb-3 tembusan-header">
                <div class="d-flex align-items-center gap-3">
                    <h4 class="mb-0">Tembusan</h4>
            ...
            <div class="data_container mt-2" style="overflow-x: auto;">
                <table id="tembusanTable" class="display nowrap cell-border hover" cellspacing="0" style="width:100%">              
                    @if($datas1->count() > 0)
                    <thead>
                        <tr>
                            <th scope="col">No</th>
...
<script>
    $(document).ready(function() {
        var table = $('#tembusanTable').DataTable({
            dom: 'lftip',
            responsive: true,
        });
